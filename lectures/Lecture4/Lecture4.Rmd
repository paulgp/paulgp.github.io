...
$$ 
E(r_{i}) = r_{f} + \frac{Cov(r_{i}, r_{m})}{Var(r_{m})}\bigg(E(r_{m}) - r_{f}\bigg) = r_{f} + \beta_{i}\bigg(E(r_{m}) - r_{f}\bigg)
$$
...
* The new portfolio, C, offers an additional 1\% return
    - Buy \$100 of C that pays $7 + 0.5 \times (100 \times F)$
    - Sell \$100 of B that pays $6 + 0.5 \times (100 \times F)$
