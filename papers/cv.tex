...
\begin{enumerate}
	\item Paul Goldsmith-Pinkham \href{https://arxiv.org/abs/2405.20604}{``Tracking the Credibility Revolution across Fields''} (Submitted, 2026)
	\item Arun Chandrasekhar, Paul Goldsmith-Pinkham, Tyler McCormick, Samuel Thau and Jerry Wei (2026) \href{https://paulgp.github.io/papers/diffusion_error_CGPMTW.pdf}{``Non-robustness of diffusion estimates on networks with measurement error''} (Resubmitted, \ul{Econometrica})
