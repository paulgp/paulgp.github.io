...
\item Paul Goldsmith-Pinkham \href{https://arxiv.org/abs/2405.20604}{``Tracking the Credibility Revolution across Fields''} (2024)
...
\begin{enumerate}
  ...
  \item Abhijit Banerjee, Marcella Alsan, Emily Breza, Arun G. Chandrasekhar, Abhijit Chowdhury, Esther Duflo, Paul Goldsmith-Pinkham, and Benjamin A. Olken (Forthcoming, 2024), \href{https://economics.mit.edu/sites/default/files/2022-08/wb_manuscript_final.pdf}{``Can a Trusted Messenger Change Behavior when Information is Plentiful? Evidence from the First Months of the COVID-19 Pandemic in West Bengal''}   \ul{Review of Economics and Statistics}
