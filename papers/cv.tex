...
\begin{enumerate}
	\item Paul Goldsmith-Pinkham and Tianshu Lyu (2025) \href{http://paulgp.github.io/papers/financial_event_studies_nov18.pdf}{``Causal Inference in Financial Event Studies''}
	\item Paul Goldsmith-Pinkham, Peter Hull and Michal Kolesar (2025) \href{https://arxiv.org/abs/2511.03572}{``Leniency Designs: An Operator's Manual''} (Solicited and Submitted, \ul{Journal of Economic Perspectives})
	\item Florian Ederer, Paul Goldsmith-Pinkham, and Kyle Jensen (2024) \href{https://florianederer.github.io/ejmr.pdf}{``Anonymity and Identity Online''}  (Revise and Resubmit, \ul{Review of Economic Studies})
	\item Arun Chandrasekhar, Paul Goldsmith-Pinkham, Tyler McCormick, Samuel Thau and Jerry Wei (2024) \href{https://paulgp.github.io/papers/diffusion_error_CGPMTW.pdf}{``Non-robustness of diffusion estimates on networks with measurement error''} (Revise and Resubmit, \ul{Econometrica})
	\item Dong Beom Choi, Paul Goldsmith-Pinkham, and Tanju Yorulmazer (2023) \href{https://arxiv.org/pdf/2308.06642.pdf}{``Contagion Effects of the Silicon Valley Bank Run''}  (Reject and Resubmit, \ul{Journal of Financial Economics})
	\item Paul Goldsmith-Pinkham \href{https://arxiv.org/abs/2405.20604}{``Tracking the Credibility Revolution across Fields''} (Submitted, 2024)
...
\begin{enumerate}
	\item Paul Goldsmith-Pinkham, Maxim Pinkovskiy and Jacob Wallace (2026), \href{http://paulgp.github.io/papers/GPW_compressed.pdf}{``Medicare and the Geography of Financial Health''} (Conditionally Accepted, \ul{Review of Economics and Statistics})
	\item Florian Ederer, Paul Goldsmith-Pinkham, and Kyle Jensen (May 2025) \href{https://florianederer.github.io/anonymous_P&P.pdf}{``Anonymous Attention and Abuse''} \ul{AEA Papers and Proceedings}
	\item Paul Goldsmith-Pinkham, Peter Hull and Michal Kolesar (December 2024) \href{https://arxiv.org/abs/2106.05024}{``Contamination Bias in Linear Regressions''} \ul{American Economic Review}
	\item Sonia Gilbukh and Paul Goldsmith-Pinkham (November 2024), \href{http://paulgp.github.io/papers/Heterogeneous_Real_Estate_Agents_and_the_Housing_Cycle.pdf}{``Heterogeneous Real Estate Agents and the Housing Cycle''} \ul{Review of Financial Studies}
	\item Abhijit Banerjee, Marcella Alsan, Emily Breza, Arun G. Chandrasekhar, Abhijit Chowdhury, Esther Duflo, Paul Goldsmith-Pinkham, and Benjamin A. Olken (September, 2024), \href{https://economics.mit.edu/sites/default/files/2022-08/wb_manuscript_final.pdf}{``Can a Trusted Messenger Change Behavior when Information is Plentiful? Evidence from the First Months of the COVID-19 Pandemic in West Bengal''}   \ul{Review of Economics and Statistics}
